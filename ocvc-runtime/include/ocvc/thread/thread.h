...
namespace oc {
  namespace thread {
    ...
    /*! \brief Get the current thread's ID as a oc_thread_t
     *
     ...
     */
    OC_RUNTIME_API oc_thread_t get_current_thread_id();
     ...
     * use in this fashion).
     */
    OC_RUNTIME_API void thread_bind_to_processor(const std::vector<int> &mask);
     ...
     * use in this fashion).
     */
    OC_RUNTIME_API void thread_bind_to_processor(int n);
     ...
     * use in this fashion).
     */
    OC_RUNTIME_API void thread_bind_to_processor(oc_thread_t thread,
     ...
     * use in this fashion).
     */
    OC_RUNTIME_API void thread_unbind();
     ...
     * use in this fashion).
     */
    OC_RUNTIME_API void thread_unbind(oc_thread_t thread);

    /*! \brief get current thread priority for a given thread ID
     *
     * Note: this does not work on OSX
     */
    OC_RUNTIME_API int thread_priority(oc_thread_t thread);
    
    /*! \brief get current thread priority for a given thread ID
     *
     * Note: this does not work on OSX
     */
    OC_RUNTIME_API int set_thread_priority(oc_thread_t thread, int priority);
