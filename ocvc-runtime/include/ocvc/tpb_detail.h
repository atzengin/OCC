...
#ifndef INCLUDED_OC_TPB_DETAIL_H
#define INCLUDED_OC_TPB_DETAIL_H
...
namespace oc {
   ...
   */
  struct OC_RUNTIME_API tpb_detail {
    oc::thread::mutex			mutex;			//< protects all vars
    bool				input_changed;
    oc::thread::condition_variable	input_cond;
    bool				output_changed;
    oc::thread::condition_variable	output_cond;
...
#endif /* INCLUDED_OC_TPB_DETAIL_H */
