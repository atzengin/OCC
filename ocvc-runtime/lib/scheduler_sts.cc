...
#include <ocvc/thread/thread_body_wrapper.h>
...
namespace oc {
    ...
    : scheduler(ffg, max_noutput_items)
  {
    ...
    // an instance of the oc_single_threaded_scheduler
    ...
    for(std::vector<basic_block_vector_t>::iterator p = graphs.begin();
      ...
      d_threads.create_thread(
        oc::thread::thread_body_wrapper<sts_container>(sts_container(blocks),
