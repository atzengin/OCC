...
#ifndef INCLUDED_OC_SCHEDULER_TPB_H
#define INCLUDED_OC_SCHEDULER_TPB_H
...
namespace oc {
   ...
   */
  class OC_RUNTIME_API scheduler_tpb : public scheduler
  {
...
#endif /* INCLUDED_OC_SCHEDULER_TPB_H */
